...
**La ventana que cubres es de hoy jueves al domingo de la semana que entra** —o sea diez u once días—, y llenas `days` y `events` con eso. **La tira que se ve es una ventana rodante que empieza en HOY —hoy y los seis días que siguen— y la calcula la página sola con la fecha del navegador**, no tu `days`: tú pones los eventos con su fecha y cada uno cae en su día. No hay días muertos que evitar y no tienes que cuadrar `days` con nada; un día sin eventos sale apagado y está bien. Como corres en jueves, tu edición llena la ventana completa ese día y la cola se va vaciando hasta la siguiente corrida: es lo esperado. Cambió el 13 sep 2026 — antes la rejilla era lunes→domingo fija, y antes de eso la semana era jueves→miércoles.
